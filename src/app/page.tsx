    ...
    <div className="md:pb-5">
      ...
      <div className="flex flex-col justify-center md:mt-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-1 md:gap-4 flex-col w-full py-3 px-2 md:px-5">
            {areas.map ((area: any) => (
              <div className="bg-[#ffffff] w-full border-2 border-[#948979] rounded shadow-lg p-2 md:p-4 flex flex-col md:flex-row gap-3 items-center hover:bg-[#e2ded7] transition-all duration-300">
                <div className="flex flex-col gap-1">
